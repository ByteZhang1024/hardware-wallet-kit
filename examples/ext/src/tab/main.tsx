/**
 * Full-tab wallet UI — where all operations actually happen.
 *
 * Opened by the popup launcher. A tab survives focus changes,
 * so Trezor's confirmation popup can open without killing our page.
 */
